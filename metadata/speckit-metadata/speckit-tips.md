...
├── ● Fetch latest release (release v0.0.69 (54,055 bytes))
├── ● Download template (spec-kit-template-gemini-sh-v0.0.69.zip)
├── ● Extract template
...
│                                                                                                                                                        │
╰────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────╯
(base) developer@df3f7db5d5da:~/dev/mount/GitReviewer(feature/sono99_diff_parser)$ 