...
Below is the complete, consolidated code for the com.sono99.ast
package.

Note: For practical file organization, each section commented with \-\--
 com.sono99.ast.XYZ.java \-\-- should typically be in its own .java
file.
...
This Java AST parsing module ( com.sono99.ast) is not just \"good
